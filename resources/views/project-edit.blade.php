...
<form class="flex-column pd-2 mgy-3 w-100 border-box br-2 bg-in inner-shadow" enctype="multipart/form-data" method="POST" action="">
    ...
    <input class="br-1 input1 cl-black pd-2" type="text" name="judul" value="{{ $project->judul }}">
    <label class="mgt-3" for="">Deskripsi</label>
    <input class="br-1 input1 cl-black pd-2" type="text" name="deskripsi" value="{{ $project->deskripsi }}">
    <label class="mgt-3" for="">Link</label>
    <input class="br-1 input1 cl-black pd-2" type="text" name="link" value="{{ $project->link }}">
